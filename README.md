...
Telegram-бот для управления VPN-профилями [AmneziaVPN](https://amnezia.org) через [amnezia-api](https://github.com/amnezia-vpn/amnezia-api). Поддерживает мультипрофили, полноценную админ-панель, Telegram Mini App и публичный веб-сервис для выдачи конфигов по секретному ключу.
